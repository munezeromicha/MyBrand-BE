...
var individualPost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var post, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, postModel_1.default.findById(req.params.id)];
            case 1:
                post = _a.sent();
                if (!post) {
...
var deleteItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, postModel_1.default.findByIdAndDelete(req.params.id)];
            case 1:
                deletedPost = _a.sent();
                if (!deletedPost) {
                    res.status(404).send({ error: 'Post not found' });
